...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    # # Uncomment code below to perform softmax for mod3 test set using same model
...
# print('softmaxmod3 test_error=', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
def run_softmax_on_MNIST_with_custom(train_x, train_y, test_x, test_y, temp_parameter=1):
    theta, cost_function_history = softmax_regression(train_x, train_y, temp_parameter, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
    # plot_cost_function_over_time(cost_function_history)
    test_error = compute_test_error(test_x, test_y, theta, temp_parameter)
    return test_error

# print('softmax with PCA: test_error=', run_softmax_on_MNIST_with_custom(train_pca, train_y, test_pca, test_y, temp_parameter=1))
...
print('softmax with Cubic features: test_error=', run_softmax_on_MNIST_with_custom(train_cube, train_y, test_cube, test_y, temp_parameter=1))
